...
namespace Com.AyriaPlatform.APG.Model
{
    ...
    public partial class AyriaPaymentV1Command :  IEquatable<AyriaPaymentV1Command>, IValidatableObject
    {
        ...
        /// <param name="issuerMustVerifyPayment">Set it to &#39;true&#39; if you want to verify payment.</param>
        /// <param name="callbackUrl">Useful for when you want to have dynamic callback url.</param>
        /// <param name="kalas">kalas.</param>
        public AyriaPaymentV1Command(long referralCode = default(long), long amount = default(long), string payerMobile = default(string), string payerName = default(string), string description = default(string), string paymentNumber = default(string), string extraData = default(string), bool issuerMustVerifyPayment = default(bool), string callbackUrl = default(string), List<AyriaPaymentV1KalaDTO> kalas = default(List<AyriaPaymentV1KalaDTO>))
        {
        ...
        /// <summary>
        /// Set it to &#39;true&#39; if you want to verify payment
        /// </summary>
        /// <value>Set it to &#39;true&#39; if you want to verify payment</value>
        [DataMember(Name="issuerMustVerifyPayment", EmitDefaultValue=false)]
        public bool IssuerMustVerifyPayment { get; set; }

        /// <summary>
        /// Useful for when you want to have dynamic callback url
        /// </summary>
        /// <value>Useful for when you want to have dynamic callback url</value>
